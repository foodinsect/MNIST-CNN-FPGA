...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=5,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=5,da_bram_cntlr_cnt=5,da_clkrst_cnt=3,da_ps7_cnt=2,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire rstn_i_1;
  wire start_i_1;
  wire top_cnn_0_done_intr_o;
  wire top_cnn_0_done_led_o;
  wire [31:0]top_cnn_0_y_buf_addr;
  wire [31:0]top_cnn_0_y_buf_data;
  wire top_cnn_0_y_buf_en;
  wire top_cnn_0_y_buf_wr_en;

  assign clk_1 = clk;
  assign done_led_o = top_cnn_0_done_led_o;
  assign rstn_i_1 = rst_n;
  ...
  design_1_top_cnn_0_0 top_cnn_0
       (.clk(clk_1),
        .done_intr_o(top_cnn_0_done_intr_o),
        .done_led_o(top_cnn_0_done_led_o),
        .rst_n(rstn_i_1),
        .start_i(start_i_1),
        .y_buf_addr(top_cnn_0_y_buf_addr),
        .y_buf_data(top_cnn_0_y_buf_data),
        .y_buf_en(top_cnn_0_y_buf_en),
        .y_buf_wr_en(top_cnn_0_y_buf_wr_en));
endmodule
