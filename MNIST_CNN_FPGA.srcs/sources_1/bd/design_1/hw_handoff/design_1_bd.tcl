...
proc create_root_design { parentCell } {
  ...
  set rstn_i [ create_bd_port -dir I rstn_i ]
  ...
  # Create instance: myMNIST_CNN_0, and set properties
  set myMNIST_CNN_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:myMNIST_CNN:1.0 myMNIST_CNN_0 ]
  ...
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins axi_smc/M01_AXI] [get_bd_intf_pins myMNIST_CNN_0/S00_AXI]
  ...
  connect_bd_net -net myMNIST_CNN_0_done_intr_o [get_bd_pins myMNIST_CNN_0/done_intr_o] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net myMNIST_CNN_0_done_led_o [get_bd_ports done_led_o] [get_bd_pins myMNIST_CNN_0/done_led_o]
  connect_bd_net -net myMNIST_CNN_0_y_buf_addr [get_bd_pins axi_bram_ctrl_0_bram/addrb] [get_bd_pins myMNIST_CNN_0/y_buf_addr]
  connect_bd_net -net myMNIST_CNN_0_y_buf_data [get_bd_pins axi_bram_ctrl_0_bram/dinb] [get_bd_pins myMNIST_CNN_0/y_buf_data]
  connect_bd_net -net myMNIST_CNN_0_y_buf_en [get_bd_pins axi_bram_ctrl_0_bram/enb] [get_bd_pins myMNIST_CNN_0/y_buf_en]
  connect_bd_net -net myMNIST_CNN_0_y_buf_wr_en [get_bd_pins axi_bram_ctrl_0_bram/web] [get_bd_pins myMNIST_CNN_0/y_buf_wr_en]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_0_bram/clkb] [get_bd_pins axi_smc/aclk] [get_bd_pins myMNIST_CNN_0/clk_i] [get_bd_pins myMNIST_CNN_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins myMNIST_CNN_0/s00_axi_aresetn] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net rstn_i_1 [get_bd_ports rstn_i] [get_bd_pins axi_bram_ctrl_0_bram/rstb] [get_bd_pins myMNIST_CNN_0/rstn_i]
  connect_bd_net -net start_i_1 [get_bd_ports start_i] [get_bd_pins myMNIST_CNN_0/start_i]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs myMNIST_CNN_0/S00_AXI/S00_AXI_reg] SEG_myMNIST_CNN_0_S00_AXI_reg
