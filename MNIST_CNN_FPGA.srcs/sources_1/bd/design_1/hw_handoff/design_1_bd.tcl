...
proc create_root_design { parentCell } {
  ...
  # Create instance: top_cnn_0, and set properties
  set block_name top_cnn
  set block_cell_name top_cnn_0
  if { [catch {set top_cnn_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_0_bram/clkb] [get_bd_pins axi_smc/aclk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins top_cnn_0/clk]
  connect_bd_net -net rstn_i_1 [get_bd_ports rst_n] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_0_bram/rstb] [get_bd_pins axi_smc/aresetn] [get_bd_pins top_cnn_0/rst_n]
  connect_bd_net -net start_i_1 [get_bd_ports start_i] [get_bd_pins top_cnn_0/start_i]
  connect_bd_net -net top_cnn_0_done_intr_o [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins top_cnn_0/done_intr_o]
  connect_bd_net -net top_cnn_0_done_led_o [get_bd_ports done_led_o] [get_bd_pins top_cnn_0/done_led_o]
  connect_bd_net -net top_cnn_0_y_buf_addr [get_bd_pins axi_bram_ctrl_0_bram/addrb] [get_bd_pins top_cnn_0/y_buf_addr]
  connect_bd_net -net top_cnn_0_y_buf_data [get_bd_pins axi_bram_ctrl_0_bram/dinb] [get_bd_pins top_cnn_0/y_buf_data]
  connect_bd_net -net top_cnn_0_y_buf_en [get_bd_pins axi_bram_ctrl_0_bram/enb] [get_bd_pins top_cnn_0/y_buf_en]
  connect_bd_net -net top_cnn_0_y_buf_wr_en [get_bd_pins axi_bram_ctrl_0_bram/web] [get_bd_pins top_cnn_0/y_buf_wr_en]
