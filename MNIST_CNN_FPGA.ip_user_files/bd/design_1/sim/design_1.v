...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=5,da_bram_cntlr_cnt=5,da_clkrst_cnt=3,da_ps7_cnt=2,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire myMNIST_CNN_0_done_intr_o;
  wire myMNIST_CNN_0_done_led_o;
  wire [31:0]myMNIST_CNN_0_y_buf_addr;
  wire [31:0]myMNIST_CNN_0_y_buf_data;
  wire myMNIST_CNN_0_y_buf_en;
  wire myMNIST_CNN_0_y_buf_wr_en;
  ...
  assign done_led_o = myMNIST_CNN_0_done_led_o;
  assign rstn_i_1 = rstn_i;
  ...
  design_1_myMNIST_CNN_0_0 myMNIST_CNN_0
       (.clk_i(processing_system7_0_FCLK_CLK0),
        .done_intr_o(myMNIST_CNN_0_done_intr_o),
        .done_led_o(myMNIST_CNN_0_done_led_o),
        .rstn_i(rstn_i_1),
        ...
        .start_i(start_i_1),
        .y_buf_addr(myMNIST_CNN_0_y_buf_addr),
        .y_buf_data(myMNIST_CNN_0_y_buf_data),
        .y_buf_en(myMNIST_CNN_0_y_buf_en),
        .y_buf_wr_en(myMNIST_CNN_0_y_buf_wr_en));
  ...
  design_1_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr[14:0]),
        ...
        .IRQ_F2P(myMNIST_CNN_0_done_intr_o),
