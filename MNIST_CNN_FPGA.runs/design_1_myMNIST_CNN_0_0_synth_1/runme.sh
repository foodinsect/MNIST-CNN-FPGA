...
HD_PWD='F:/MNIST_CNN_FPGA/MNIST_CNN_FPGA.runs/design_1_myMNIST_CNN_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_myMNIST_CNN_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_myMNIST_CNN_0_0.tcl
