...
HD_PWD='D:/MNIST-CNN-FPGA-S/MNIST_CNN_FPGA.runs/design_1_top_cnn_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_top_cnn_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_top_cnn_0_0.tcl
